...
getSTART <- function(){
  ...
  return( c(
    ...
    "HEADER: k1 - the core mutation rate constant for b1->b2 in byr-1.",
    "HEADER: k2 - the core mutation rate constant for b1->b3 in byr-1.",
    "HEADER: k3 - the core mutation rate constant for b1->b4 in byr-1.",
